...
#'
#' @param resultList can be a dataframe of the data that is already prepared by PrepareMLETData_HMLET or a list that is the result of PermutationTest_MLET
#'
#' @export
